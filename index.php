    ...
    <div class="container mt-4" id="Home_Nav">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6 right-image">
                <img src="https://www.wellstar.org/-/media/project/wellstar/org/medical-services/hospital.png?rev=9d51ef8d64ee4b4caf49b4907ebbccfa" alt="Right Image" class="main-image" id="imgbdr">
            </div>
        </div>
        ...
        <div class="row mt-4" id="doctor-grid">
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <img src="https://www.akshahospital.in/wp-content/uploads/2022/02/07.jpg" alt="Doctor 1" class="doctor-image">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://www.akshahospital.in/wp-content/uploads/2022/02/abtm-1.jpg" alt="Doctor 2" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
                        <h3>Dr. Jane Smith</h3>
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://www.akshahospital.in/wp-content/uploads/2022/02/06.jpg" alt="Doctor 3" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
                        <h3>Dr. Madhuri</h3>
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://www.akshahospital.in/wp-content/uploads/2022/02/smita.jpg" alt="Doctor 4" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
                        <h3>Dr. Smitha Bhoopal</h3>
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://jeevikahospital.com/wp-content/uploads/2024/03/DSC03885-rotated-e1710766613133.jpg" alt="Doctor 3" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
            ...
            <div class="col-md-6 doctor-item">
                <div class="row">
                    <div class="col-md-6">
                        <!-- Left side - Doctor image -->
                        <img src="https://jeevikahospital.com/wp-content/uploads/2024/03/DSC03956-1-rotated-e1710507789703.jpg" alt="Doctor 4" class="doctor-image">
                    </div>
                    <div class="col-md-6">
                        <!-- Right side - Doctor name and specialty -->
